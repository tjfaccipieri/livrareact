...
import DeleteProduto from '../components/produtos/DeleteProduto';
import ModalDelete from '../components/produtos/ModalDelete';
    ...
    <div className="container mx-auto py-8 flex flex-col gap-4">
      ...
      <div className="flex justify-center gap-28 items-center mt-8">
        <img
          ...
          alt=""
          className="w-48 rounded-full border-4 p-1 border-purple-900"
        />
        <div className="flex flex-col gap-4 justify-center ">
          <p>E-mail de cadastro: {usuario.usuario}</p>
          <p>
            Quantidade de produtos cadastrados:{' '}
            {user.produto?.length || 'você ainda não tem produtos cadastrados'}
          </p>
          <Link
            to="/cadastroProduto"
            className="mx-auto w-2/3 bg-purple-800 hover:bg-purple-950 text-white py-2 rounded-xl text-center"
          >
