  ...
  return (
    <div className="container mx-auto py-8 flex flex-col gap-4">
      ...
      <div className="flex justify-center gap-28 items-center mt-8">
        <img
          src="https://i.imgur.com/0Hpwnjx.png"
          alt=""
          className="w-48 rounded-full border-4 p-1 border-purple-900"
        />
        <div className="flex flex-col text-xl font-bold gap-4">
          <p>E-Mail de cadastro: thiago@email.com</p>
          <p>Quantidade de produtos cadastrados: 2</p>
          <Link to="/cadastroProduto">
            <button className="mx-auto w-2/3 bg-purple-800 hover:bg-purple-950 text-white py-2 rounded-xl">
