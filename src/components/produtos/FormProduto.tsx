    ...
    <div className='container mx-auto flex flex-col mt-8 min-h-[85vh]'>
      ...
      <form className='flex flex-col gap-8' onSubmit={handleForm}>
        ...
        <div className="flex flex-col">
          <label htmlFor="titulo" hidden>Titulo do livro</label>
          <input
            type="text"
            name='titulo'
        ...
        <div className="flex flex-col">
          <label htmlFor="autor" hidden>Autor do livro</label>
          <input
            type="text"
            name='autor'
            value={produto.autor}
        ...
        <div className="flex flex-col">
          <label htmlFor="foto" hidden>foto do livro</label>
          <input
            type="text"
            name='foto'
            value={produto.foto}
        ...
        <div className="flex flex-col">
          <label htmlFor="preco" hidden>preço do livro</label>
          <input
            type="text"
            name='preco'
            value={produto.preco}
        ...
        <button type='submit' className='border-purple-900 border-2 w-1/2 mx-auto rounded hover:bg-purple-900 hover:text-white text-purple-900 font-bold uppercase py-1'>Cadastrar livro</button>
      </form>
    </div>
  )
}
